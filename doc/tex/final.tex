...
NeurIPS requires electronic submissions.  The electronic \cite{LagTime} submission site is
\begin{center}
...
Papers \cite{einstein} to be submitted to NeurIPS 2018 must be prepared according to the
...
\cite{gabrielsson2012non} Use unnumbered third level headings for the acknowledgments. All acknowledgments
